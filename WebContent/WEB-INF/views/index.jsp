        ...
        <tbody>          
        	<c:forEach var="cliente" items="${contabilidad.getListaProveedores()}">
                <tr>
                    ...
                    <td><a href="clientes?clienteName=<c:out value="${cliente.name}"/>">Ver</a></td>
                    ...
                    <td><a href="actualiza?action=Actualiza&clienteName=<c:out value="${cliente.name}"/>">Actualizar</a></td>
                    <td><a href="borra?action=Borra&clienteName=<c:out value="${cliente.name}"/>">Borrar</a></td>
                </tr>
            </c:forEach>
        </tbody>
    </table>
